    ...
    <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0  wow animate__animated animate__fadeInUp" data-wow-delay="0">
        <div class="logo mb-30">
            @if (theme_option('logo'))
                <a href="{{ route('public.index') }}" class="mb-15"><img class="img-logo-footer" src="{{ RvMedia::getImageUrl(theme_option('logo')) }}" alt="{{ theme_option('site_title') }}"></a>
            @endif
        ...
        <ul class="contact-infor">
            @if ($config['address'])
                <li>
                    ...
                    <strong>{{ __('Address') }}:</strong>&nbsp;<span>{!! BaseHelper::clean($config['address']) !!}</span>
                </li>
            @endif
            @if ($config['phone'])
                <li>
            ...
            @if ($config['working_hours'])
                <li>
                    ...
                    <strong>{{ __('Working Hours') }}:</strong>&nbsp;<span>{!! BaseHelper::clean($config['working_hours']) !!}</span>
                </li>
            @endif
        </ul>
    </div>
